        ...
        <>
              <div className="bg-white lg:w-4/12 md:6/12 w-10/12 m-auto my-10 shadow-md">
                <div className="py-8 px-8 rounded-xl">
                    <h1 className="font-medium text-2xl mt-3 text-center">Add Student Form</h1>
                    ...
                    <div className="my-5 text-sm">
                        ...
                        <div className="my-5 text-sm">
                            ...
                            <select name="batch" value= {batch} onChange={e => onInputChange(e)} className="rounded-sm px-4 py-3 mt-3 focus:outline-none bg-gray-100 w-full">
