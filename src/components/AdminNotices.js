             ...
             <div>
                <div class="flex flex-col max-w-full shadow-md m-6">
                    ...
                    <div class="flex justify-between items-center bg-blue-500 border-b px-6 py-4">
                        <p class="text-xl text-white font-semibold">Notices</p>

                        <Link to={`/admin/addNotice`} class="bg-blue-600 hover:bg-blue-700 text-white text-xs px-6 py-2 rounded-lg border-0">Add New Notice</Link>
                    </div>
                    {/*  End Header  */}
