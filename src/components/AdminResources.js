 ...
 <div>
                <div className="flex flex-col max-w-full shadow-md m-6">
                    ...
                    <div className="flex justify-between items-center bg-blue-500 border-b px-6 py-4">
                        <p className="text-xl text-white font-semibold">Files</p>

                        <Link to={`/admin/addFile`} className="bg-blue-600 hover:bg-blue-700 text-white text-xs px-6 py-2 rounded-lg border-0">Add New File</Link>
                    </div>
                    {/*  End Header  */}
                    ...
                    <table className="overflow-y-scroll w-full bg-white divide-y divide-gray-200">
                        ...
                        {users.map((user, index) => (
                            <tr key={user._id} className="text-center">
                                ...
                                <td className="py-3">{user.filename}</td>
