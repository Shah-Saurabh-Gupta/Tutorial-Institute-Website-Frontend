                    ...
                    <div className="flex flex-wrap md:-m-2 -m-1">
                        <div className="flex flex-wrap w-1/2">
                            <div className="md:p-2 p-1 w-1/2">
                                <img alt="gallery" className="w-full object-cover h-full object-center block" src="images/gallery_1.png" />
                            </div>
                            <div className="md:p-2 p-1 w-1/2">
                        ...
                        <div className="flex flex-wrap w-1/2">
                            ...
                            <div className="md:p-2 p-1 w-1/2">
                                <img alt="gallery" className="w-full object-cover h-full object-center block" src="images/gallery_3.png" />
                            </div>
                        </div>
                    </div>
                </div>
